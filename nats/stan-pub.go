...
func main() {
	...
	flag.StringVar(&Usr, "usr", "jim", "specific the nats streaming cluster coonect usr.")
	flag.StringVar(&Passwd, "pwd", "password", "specific the nats streaming cluster connect usr password.")
